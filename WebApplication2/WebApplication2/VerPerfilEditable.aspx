...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ForoConnectionString %>" SelectCommand="SELECT * FROM [usuario] WHERE ([id_usuario] = @id_usuario)">
            <SelectParameters>
                <asp:SessionParameter Name="id_usuario" SessionField="id_usuario2" Type="Decimal" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
        ...
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" style="margin-left: 82px" Text="Editar" />
    </form>
</body>
</html>
